...
@Controller("ctr90")
public class Controller90 {
   @Autowired
   private Controller90 controller0;
   @Autowired
   private Controller90 controller1;
   @Autowired
   private Controller90 controller2;
   @Autowired
   private Controller90 controller3;
   @Autowired
   private Controller90 controller4;
