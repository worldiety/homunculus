...
@Controller("ctr84")
public class Controller84 {
   @Autowired
   private Controller84 controller0;
   @Autowired
   private Controller84 controller1;
   @Autowired
   private Controller84 controller2;
   @Autowired
   private Controller84 controller3;
   @Autowired
   private Controller84 controller4;
