...
public class Controller79 {
   @Autowired
   private Controller79 controller0;
   @Autowired
   private Controller79 controller1;
   @Autowired
   private Controller79 controller2;
   @Autowired
   private Controller79 controller3;
   @Autowired
   private Controller79 controller4;
