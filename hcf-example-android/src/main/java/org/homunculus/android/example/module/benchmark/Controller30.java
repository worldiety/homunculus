...
public class Controller30 {
   @Autowired
   private Controller30 controller0;
   @Autowired
   private Controller30 controller1;
   @Autowired
   private Controller30 controller2;
   @Autowired
   private Controller30 controller3;
   @Autowired
   private Controller30 controller4;
