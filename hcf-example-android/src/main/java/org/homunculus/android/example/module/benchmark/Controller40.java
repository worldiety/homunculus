...
public class Controller40 {
   @Autowired
   private Controller40 controller0;
   @Autowired
   private Controller40 controller1;
   @Autowired
   private Controller40 controller2;
   @Autowired
   private Controller40 controller3;
   @Autowired
   private Controller40 controller4;
