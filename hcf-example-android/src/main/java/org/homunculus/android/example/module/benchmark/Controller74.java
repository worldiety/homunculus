...
@Controller("ctr74")
public class Controller74 {
   @Autowired
   private Controller74 controller0;
   @Autowired
   private Controller74 controller1;
   @Autowired
   private Controller74 controller2;
   @Autowired
   private Controller74 controller3;
   @Autowired
   private Controller74 controller4;
