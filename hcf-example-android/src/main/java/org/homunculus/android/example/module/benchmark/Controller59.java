...
@Controller("ctr59")
public class Controller59 {
   @Autowired
   private Controller59 controller0;
   @Autowired
   private Controller59 controller1;
   @Autowired
   private Controller59 controller2;
   @Autowired
   private Controller59 controller3;
   @Autowired
   private Controller59 controller4;
