...
@Controller("ctr83")
public class Controller83 {
   @Autowired
   private Controller83 controller0;
   @Autowired
   private Controller83 controller1;
   @Autowired
   private Controller83 controller2;
   @Autowired
   private Controller83 controller3;
   @Autowired
   private Controller83 controller4;
