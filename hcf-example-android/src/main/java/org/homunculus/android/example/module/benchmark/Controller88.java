...
public class Controller88 {
   @Autowired
   private Controller88 controller0;
   @Autowired
   private Controller88 controller1;
   @Autowired
   private Controller88 controller2;
   @Autowired
   private Controller88 controller3;
   @Autowired
   private Controller88 controller4;
