...
@Controller("ctr85")
public class Controller85 {
   @Autowired
   private Controller85 controller0;
   @Autowired
   private Controller85 controller1;
   @Autowired
   private Controller85 controller2;
   @Autowired
   private Controller85 controller3;
   @Autowired
   private Controller85 controller4;
