...
@Controller("ctr87")
public class Controller87 {
   @Autowired
   private Controller87 controller0;
   @Autowired
   private Controller87 controller1;
   @Autowired
   private Controller87 controller2;
   @Autowired
   private Controller87 controller3;
   @Autowired
   private Controller87 controller4;
