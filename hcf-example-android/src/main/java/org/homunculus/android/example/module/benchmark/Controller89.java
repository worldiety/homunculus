...
@Controller("ctr89")
public class Controller89 {
   @Autowired
   private Controller89 controller0;
   @Autowired
   private Controller89 controller1;
   @Autowired
   private Controller89 controller2;
   @Autowired
   private Controller89 controller3;
   @Autowired
   private Controller89 controller4;
