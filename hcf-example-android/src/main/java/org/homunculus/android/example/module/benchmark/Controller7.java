...
public class Controller7 {
   @Autowired
   private Controller7 controller0;
   @Autowired
   private Controller7 controller1;
   @Autowired
   private Controller7 controller2;
   @Autowired
   private Controller7 controller3;
   @Autowired
   private Controller7 controller4;
