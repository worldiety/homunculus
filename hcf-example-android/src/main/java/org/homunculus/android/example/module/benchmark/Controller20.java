...
public class Controller20 {
   @Autowired
   private Controller20 controller0;
   @Autowired
   private Controller20 controller1;
   @Autowired
   private Controller20 controller2;
   @Autowired
   private Controller20 controller3;
   @Autowired
   private Controller20 controller4;
