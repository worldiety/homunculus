...
public class Controller72 {
   @Autowired
   private Controller72 controller0;
   @Autowired
   private Controller72 controller1;
   @Autowired
   private Controller72 controller2;
   @Autowired
   private Controller72 controller3;
   @Autowired
   private Controller72 controller4;
