...
@Controller("ctr93")
public class Controller93 {
   @Autowired
   private Controller93 controller0;
   @Autowired
   private Controller93 controller1;
   @Autowired
   private Controller93 controller2;
   @Autowired
   private Controller93 controller3;
   @Autowired
   private Controller93 controller4;
