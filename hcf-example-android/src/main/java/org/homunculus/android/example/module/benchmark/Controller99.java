...
public class Controller99 {
   @Autowired
   private Controller99 controller0;
   @Autowired
   private Controller99 controller1;
   @Autowired
   private Controller99 controller2;
   @Autowired
   private Controller99 controller3;
   @Autowired
   private Controller99 controller4;
