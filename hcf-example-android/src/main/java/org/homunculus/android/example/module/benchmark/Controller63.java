...
@Controller("ctr63")
public class Controller63 {
   @Autowired
   private Controller63 controller0;
   @Autowired
   private Controller63 controller1;
   @Autowired
   private Controller63 controller2;
   @Autowired
   private Controller63 controller3;
   @Autowired
   private Controller63 controller4;
