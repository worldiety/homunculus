...
public class Controller25 {
   @Autowired
   private Controller25 controller0;
   @Autowired
   private Controller25 controller1;
   @Autowired
   private Controller25 controller2;
   @Autowired
   private Controller25 controller3;
   @Autowired
   private Controller25 controller4;
