...
public class Controller80 {
   @Autowired
   private Controller80 controller0;
   @Autowired
   private Controller80 controller1;
   @Autowired
   private Controller80 controller2;
   @Autowired
   private Controller80 controller3;
   @Autowired
   private Controller80 controller4;
