...
public class Controller21 {
   @Autowired
   private Controller21 controller0;
   @Autowired
   private Controller21 controller1;
   @Autowired
   private Controller21 controller2;
   @Autowired
   private Controller21 controller3;
   @Autowired
   private Controller21 controller4;
