...
@Controller("ctr69")
public class Controller69 {
   @Autowired
   private Controller69 controller0;
   @Autowired
   private Controller69 controller1;
   @Autowired
   private Controller69 controller2;
   @Autowired
   private Controller69 controller3;
   @Autowired
   private Controller69 controller4;
