...
public class Controller46 {
   @Autowired
   private Controller46 controller0;
   @Autowired
   private Controller46 controller1;
   @Autowired
   private Controller46 controller2;
   @Autowired
   private Controller46 controller3;
   @Autowired
   private Controller46 controller4;
