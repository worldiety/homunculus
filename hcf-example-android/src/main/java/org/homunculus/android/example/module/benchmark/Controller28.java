...
public class Controller28 {
   @Autowired
   private Controller28 controller0;
   @Autowired
   private Controller28 controller1;
   @Autowired
   private Controller28 controller2;
   @Autowired
   private Controller28 controller3;
   @Autowired
   private Controller28 controller4;
