...
public class Controller47 {
   @Autowired
   private Controller47 controller0;
   @Autowired
   private Controller47 controller1;
   @Autowired
   private Controller47 controller2;
   @Autowired
   private Controller47 controller3;
   @Autowired
   private Controller47 controller4;
