...
public class Controller32 {
   @Autowired
   private Controller32 controller0;
   @Autowired
   private Controller32 controller1;
   @Autowired
   private Controller32 controller2;
   @Autowired
   private Controller32 controller3;
   @Autowired
   private Controller32 controller4;
