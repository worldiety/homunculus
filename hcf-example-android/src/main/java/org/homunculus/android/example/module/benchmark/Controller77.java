...
public class Controller77 {
   @Autowired
   private Controller77 controller0;
   @Autowired
   private Controller77 controller1;
   @Autowired
   private Controller77 controller2;
   @Autowired
   private Controller77 controller3;
   @Autowired
   private Controller77 controller4;
