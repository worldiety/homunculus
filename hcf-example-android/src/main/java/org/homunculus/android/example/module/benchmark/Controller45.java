...
public class Controller45 {
   @Autowired
   private Controller45 controller0;
   @Autowired
   private Controller45 controller1;
   @Autowired
   private Controller45 controller2;
   @Autowired
   private Controller45 controller3;
   @Autowired
   private Controller45 controller4;
