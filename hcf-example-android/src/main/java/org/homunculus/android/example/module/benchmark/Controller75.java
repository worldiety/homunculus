...
@Controller("ctr75")
public class Controller75 {
   @Autowired
   private Controller75 controller0;
   @Autowired
   private Controller75 controller1;
   @Autowired
   private Controller75 controller2;
   @Autowired
   private Controller75 controller3;
   @Autowired
   private Controller75 controller4;
