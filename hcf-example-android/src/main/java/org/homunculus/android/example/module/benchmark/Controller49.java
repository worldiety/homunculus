...
public class Controller49 {
   @Autowired
   private Controller49 controller0;
   @Autowired
   private Controller49 controller1;
   @Autowired
   private Controller49 controller2;
   @Autowired
   private Controller49 controller3;
   @Autowired
   private Controller49 controller4;
