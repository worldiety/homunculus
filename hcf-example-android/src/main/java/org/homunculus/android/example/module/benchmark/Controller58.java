...
@Controller("ctr58")
public class Controller58 {
   @Autowired
   private Controller58 controller0;
   @Autowired
   private Controller58 controller1;
   @Autowired
   private Controller58 controller2;
   @Autowired
   private Controller58 controller3;
   @Autowired
   private Controller58 controller4;
