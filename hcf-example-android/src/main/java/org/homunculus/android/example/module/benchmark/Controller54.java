...
public class Controller54 {
   @Autowired
   private Controller54 controller0;
   @Autowired
   private Controller54 controller1;
   @Autowired
   private Controller54 controller2;
   @Autowired
   private Controller54 controller3;
   @Autowired
   private Controller54 controller4;
