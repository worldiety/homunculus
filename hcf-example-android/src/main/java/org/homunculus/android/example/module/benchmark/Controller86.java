...
@Controller("ctr86")
public class Controller86 {
   @Autowired
   private Controller86 controller0;
   @Autowired
   private Controller86 controller1;
   @Autowired
   private Controller86 controller2;
   @Autowired
   private Controller86 controller3;
   @Autowired
   private Controller86 controller4;
