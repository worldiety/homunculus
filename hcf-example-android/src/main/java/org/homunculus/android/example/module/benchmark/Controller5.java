...
public class Controller5 {
   @Autowired
   private Controller5 controller0;
   @Autowired
   private Controller5 controller1;
   @Autowired
   private Controller5 controller2;
   @Autowired
   private Controller5 controller3;
   @Autowired
   private Controller5 controller4;
