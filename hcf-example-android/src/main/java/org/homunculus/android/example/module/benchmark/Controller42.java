...
public class Controller42 {
   @Autowired
   private Controller42 controller0;
   @Autowired
   private Controller42 controller1;
   @Autowired
   private Controller42 controller2;
   @Autowired
   private Controller42 controller3;
   @Autowired
   private Controller42 controller4;
