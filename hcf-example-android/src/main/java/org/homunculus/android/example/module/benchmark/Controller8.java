...
public class Controller8 {
   @Autowired
   private Controller8 controller0;
   @Autowired
   private Controller8 controller1;
   @Autowired
   private Controller8 controller2;
   @Autowired
   private Controller8 controller3;
   @Autowired
   private Controller8 controller4;
