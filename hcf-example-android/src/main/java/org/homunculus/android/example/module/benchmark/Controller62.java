...
@Controller("ctr62")
public class Controller62 {
   @Autowired
   private Controller62 controller0;
   @Autowired
   private Controller62 controller1;
   @Autowired
   private Controller62 controller2;
   @Autowired
   private Controller62 controller3;
   @Autowired
   private Controller62 controller4;
