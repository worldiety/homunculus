...
public class Controller50 {
   @Autowired
   private Controller50 controller0;
   @Autowired
   private Controller50 controller1;
   @Autowired
   private Controller50 controller2;
   @Autowired
   private Controller50 controller3;
   @Autowired
   private Controller50 controller4;
