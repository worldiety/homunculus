...
@Controller("ctr95")
public class Controller95 {
   @Autowired
   private Controller95 controller0;
   @Autowired
   private Controller95 controller1;
   @Autowired
   private Controller95 controller2;
   @Autowired
   private Controller95 controller3;
   @Autowired
   private Controller95 controller4;
