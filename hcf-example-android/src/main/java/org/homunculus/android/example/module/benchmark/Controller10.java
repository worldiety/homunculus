...
public class Controller10 {
   @Autowired
   private Controller10 controller0;
   @Autowired
   private Controller10 controller1;
   @Autowired
   private Controller10 controller2;
   @Autowired
   private Controller10 controller3;
   @Autowired
   private Controller10 controller4;
