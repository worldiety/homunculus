...
public class Controller61 {
   @Autowired
   private Controller61 controller0;
   @Autowired
   private Controller61 controller1;
   @Autowired
   private Controller61 controller2;
   @Autowired
   private Controller61 controller3;
   @Autowired
   private Controller61 controller4;
