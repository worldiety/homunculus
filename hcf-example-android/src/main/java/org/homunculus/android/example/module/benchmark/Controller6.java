...
public class Controller6 {
   @Autowired
   private Controller6 controller0;
   @Autowired
   private Controller6 controller1;
   @Autowired
   private Controller6 controller2;
   @Autowired
   private Controller6 controller3;
   @Autowired
   private Controller6 controller4;
