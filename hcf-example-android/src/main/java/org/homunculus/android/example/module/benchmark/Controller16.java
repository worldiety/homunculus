...
public class Controller16 {
   @Autowired
   private Controller16 controller0;
   @Autowired
   private Controller16 controller1;
   @Autowired
   private Controller16 controller2;
   @Autowired
   private Controller16 controller3;
   @Autowired
   private Controller16 controller4;
