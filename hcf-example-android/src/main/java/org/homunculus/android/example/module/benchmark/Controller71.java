...
@Controller("ctr71")
public class Controller71 {
   @Autowired
   private Controller71 controller0;
   @Autowired
   private Controller71 controller1;
   @Autowired
   private Controller71 controller2;
   @Autowired
   private Controller71 controller3;
   @Autowired
   private Controller71 controller4;
