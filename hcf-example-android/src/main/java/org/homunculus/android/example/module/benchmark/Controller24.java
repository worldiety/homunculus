...
public class Controller24 {
   @Autowired
   private Controller24 controller0;
   @Autowired
   private Controller24 controller1;
   @Autowired
   private Controller24 controller2;
   @Autowired
   private Controller24 controller3;
   @Autowired
   private Controller24 controller4;
