...
@Controller("ctr91")
public class Controller91 {
   @Autowired
   private Controller91 controller0;
   @Autowired
   private Controller91 controller1;
   @Autowired
   private Controller91 controller2;
   @Autowired
   private Controller91 controller3;
   @Autowired
   private Controller91 controller4;
