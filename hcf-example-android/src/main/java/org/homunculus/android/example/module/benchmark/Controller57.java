...
public class Controller57 {
   @Autowired
   private Controller57 controller0;
   @Autowired
   private Controller57 controller1;
   @Autowired
   private Controller57 controller2;
   @Autowired
   private Controller57 controller3;
   @Autowired
   private Controller57 controller4;
