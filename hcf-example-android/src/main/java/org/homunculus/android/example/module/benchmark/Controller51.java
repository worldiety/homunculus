...
public class Controller51 {
   @Autowired
   private Controller51 controller0;
   @Autowired
   private Controller51 controller1;
   @Autowired
   private Controller51 controller2;
   @Autowired
   private Controller51 controller3;
   @Autowired
   private Controller51 controller4;
