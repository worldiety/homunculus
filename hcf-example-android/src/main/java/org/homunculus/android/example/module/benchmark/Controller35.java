...
public class Controller35 {
   @Autowired
   private Controller35 controller0;
   @Autowired
   private Controller35 controller1;
   @Autowired
   private Controller35 controller2;
   @Autowired
   private Controller35 controller3;
   @Autowired
   private Controller35 controller4;
