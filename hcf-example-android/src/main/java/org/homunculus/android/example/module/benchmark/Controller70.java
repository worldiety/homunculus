...
@Controller("ctr70")
public class Controller70 {
   @Autowired
   private Controller70 controller0;
   @Autowired
   private Controller70 controller1;
   @Autowired
   private Controller70 controller2;
   @Autowired
   private Controller70 controller3;
   @Autowired
   private Controller70 controller4;
