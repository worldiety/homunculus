...
@Controller("ctr67")
public class Controller67 {
   @Autowired
   private Controller67 controller0;
   @Autowired
   private Controller67 controller1;
   @Autowired
   private Controller67 controller2;
   @Autowired
   private Controller67 controller3;
   @Autowired
   private Controller67 controller4;
