...
@Controller("ctr92")
public class Controller92 {
   @Autowired
   private Controller92 controller0;
   @Autowired
   private Controller92 controller1;
   @Autowired
   private Controller92 controller2;
   @Autowired
   private Controller92 controller3;
   @Autowired
   private Controller92 controller4;
