...
@Controller("ctr78")
public class Controller78 {
   @Autowired
   private Controller78 controller0;
   @Autowired
   private Controller78 controller1;
   @Autowired
   private Controller78 controller2;
   @Autowired
   private Controller78 controller3;
   @Autowired
   private Controller78 controller4;
