...
public class Controller37 {
   @Autowired
   private Controller37 controller0;
   @Autowired
   private Controller37 controller1;
   @Autowired
   private Controller37 controller2;
   @Autowired
   private Controller37 controller3;
   @Autowired
   private Controller37 controller4;
