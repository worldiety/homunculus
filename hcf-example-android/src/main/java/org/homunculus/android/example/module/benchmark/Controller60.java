...
@Controller("ctr60")
public class Controller60 {
   @Autowired
   private Controller60 controller0;
   @Autowired
   private Controller60 controller1;
   @Autowired
   private Controller60 controller2;
   @Autowired
   private Controller60 controller3;
   @Autowired
   private Controller60 controller4;
