...
public class Controller52 {
   @Autowired
   private Controller52 controller0;
   @Autowired
   private Controller52 controller1;
   @Autowired
   private Controller52 controller2;
   @Autowired
   private Controller52 controller3;
   @Autowired
   private Controller52 controller4;
