...
@Controller("ctr82")
public class Controller82 {
   @Autowired
   private Controller82 controller0;
   @Autowired
   private Controller82 controller1;
   @Autowired
   private Controller82 controller2;
   @Autowired
   private Controller82 controller3;
   @Autowired
   private Controller82 controller4;
