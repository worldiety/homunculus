...
@Controller("ctr76")
public class Controller76 {
   @Autowired
   private Controller76 controller0;
   @Autowired
   private Controller76 controller1;
   @Autowired
   private Controller76 controller2;
   @Autowired
   private Controller76 controller3;
   @Autowired
   private Controller76 controller4;
