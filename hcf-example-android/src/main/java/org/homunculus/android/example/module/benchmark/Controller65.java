...
public class Controller65 {
   @Autowired
   private Controller65 controller0;
   @Autowired
   private Controller65 controller1;
   @Autowired
   private Controller65 controller2;
   @Autowired
   private Controller65 controller3;
   @Autowired
   private Controller65 controller4;
