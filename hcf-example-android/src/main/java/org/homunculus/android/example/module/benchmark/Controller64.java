...
@Controller("ctr64")
public class Controller64 {
   @Autowired
   private Controller64 controller0;
   @Autowired
   private Controller64 controller1;
   @Autowired
   private Controller64 controller2;
   @Autowired
   private Controller64 controller3;
   @Autowired
   private Controller64 controller4;
