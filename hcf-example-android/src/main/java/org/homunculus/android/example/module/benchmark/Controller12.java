...
public class Controller12 {
   @Autowired
   private Controller12 controller0;
   @Autowired
   private Controller12 controller1;
   @Autowired
   private Controller12 controller2;
   @Autowired
   private Controller12 controller3;
   @Autowired
   private Controller12 controller4;
