...
public class Controller36 {
   @Autowired
   private Controller36 controller0;
   @Autowired
   private Controller36 controller1;
   @Autowired
   private Controller36 controller2;
   @Autowired
   private Controller36 controller3;
   @Autowired
   private Controller36 controller4;
