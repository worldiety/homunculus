...
public class Controller56 {
   @Autowired
   private Controller56 controller0;
   @Autowired
   private Controller56 controller1;
   @Autowired
   private Controller56 controller2;
   @Autowired
   private Controller56 controller3;
   @Autowired
   private Controller56 controller4;
