...
public class Controller48 {
   @Autowired
   private Controller48 controller0;
   @Autowired
   private Controller48 controller1;
   @Autowired
   private Controller48 controller2;
   @Autowired
   private Controller48 controller3;
   @Autowired
   private Controller48 controller4;
