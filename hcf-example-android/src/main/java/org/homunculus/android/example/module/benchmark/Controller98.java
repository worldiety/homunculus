...
@Controller("ctr98")
public class Controller98 {
   @Autowired
   private Controller98 controller0;
   @Autowired
   private Controller98 controller1;
   @Autowired
   private Controller98 controller2;
   @Autowired
   private Controller98 controller3;
   @Autowired
   private Controller98 controller4;
