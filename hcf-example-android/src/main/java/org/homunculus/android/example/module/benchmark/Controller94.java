...
@Controller("ctr94")
public class Controller94 {
   @Autowired
   private Controller94 controller0;
   @Autowired
   private Controller94 controller1;
   @Autowired
   private Controller94 controller2;
   @Autowired
   private Controller94 controller3;
   @Autowired
   private Controller94 controller4;
