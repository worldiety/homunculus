...
@Controller("ctr73")
public class Controller73 {
   @Autowired
   private Controller73 controller0;
   @Autowired
   private Controller73 controller1;
   @Autowired
   private Controller73 controller2;
   @Autowired
   private Controller73 controller3;
   @Autowired
   private Controller73 controller4;
