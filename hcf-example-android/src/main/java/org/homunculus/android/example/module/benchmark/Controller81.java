...
public class Controller81 {
   @Autowired
   private Controller81 controller0;
   @Autowired
   private Controller81 controller1;
   @Autowired
   private Controller81 controller2;
   @Autowired
   private Controller81 controller3;
   @Autowired
   private Controller81 controller4;
