...
@Controller("ctr68")
public class Controller68 {
   @Autowired
   private Controller68 controller0;
   @Autowired
   private Controller68 controller1;
   @Autowired
   private Controller68 controller2;
   @Autowired
   private Controller68 controller3;
   @Autowired
   private Controller68 controller4;
