...
public class Controller44 {
   @Autowired
   private Controller44 controller0;
   @Autowired
   private Controller44 controller1;
   @Autowired
   private Controller44 controller2;
   @Autowired
   private Controller44 controller3;
   @Autowired
   private Controller44 controller4;
