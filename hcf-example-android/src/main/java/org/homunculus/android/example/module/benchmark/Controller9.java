...
public class Controller9 {
   @Autowired
   private Controller9 controller0;
   @Autowired
   private Controller9 controller1;
   @Autowired
   private Controller9 controller2;
   @Autowired
   private Controller9 controller3;
   @Autowired
   private Controller9 controller4;
