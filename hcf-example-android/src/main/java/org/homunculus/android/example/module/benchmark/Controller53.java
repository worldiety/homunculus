...
public class Controller53 {
   @Autowired
   private Controller53 controller0;
   @Autowired
   private Controller53 controller1;
   @Autowired
   private Controller53 controller2;
   @Autowired
   private Controller53 controller3;
   @Autowired
   private Controller53 controller4;
