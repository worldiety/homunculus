...
public class Controller33 {
   @Autowired
   private Controller33 controller0;
   @Autowired
   private Controller33 controller1;
   @Autowired
   private Controller33 controller2;
   @Autowired
   private Controller33 controller3;
   @Autowired
   private Controller33 controller4;
