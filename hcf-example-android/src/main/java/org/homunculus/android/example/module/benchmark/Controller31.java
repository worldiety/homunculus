...
public class Controller31 {
   @Autowired
   private Controller31 controller0;
   @Autowired
   private Controller31 controller1;
   @Autowired
   private Controller31 controller2;
   @Autowired
   private Controller31 controller3;
   @Autowired
   private Controller31 controller4;
