...
public class Controller66 {
   @Autowired
   private Controller66 controller0;
   @Autowired
   private Controller66 controller1;
   @Autowired
   private Controller66 controller2;
   @Autowired
   private Controller66 controller3;
   @Autowired
   private Controller66 controller4;
