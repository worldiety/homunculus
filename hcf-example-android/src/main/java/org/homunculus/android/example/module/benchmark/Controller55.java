...
public class Controller55 {
   @Autowired
   private Controller55 controller0;
   @Autowired
   private Controller55 controller1;
   @Autowired
   private Controller55 controller2;
   @Autowired
   private Controller55 controller3;
   @Autowired
   private Controller55 controller4;
