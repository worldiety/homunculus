...
public class Controller39 {
   @Autowired
   private Controller39 controller0;
   @Autowired
   private Controller39 controller1;
   @Autowired
   private Controller39 controller2;
   @Autowired
   private Controller39 controller3;
   @Autowired
   private Controller39 controller4;
