...
public class Controller17 {
   @Autowired
   private Controller17 controller0;
   @Autowired
   private Controller17 controller1;
   @Autowired
   private Controller17 controller2;
   @Autowired
   private Controller17 controller3;
   @Autowired
   private Controller17 controller4;
