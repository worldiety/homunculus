...
@Controller("ctr96")
public class Controller96 {
   @Autowired
   private Controller96 controller0;
   @Autowired
   private Controller96 controller1;
   @Autowired
   private Controller96 controller2;
   @Autowired
   private Controller96 controller3;
   @Autowired
   private Controller96 controller4;
