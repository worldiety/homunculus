...
@Controller("ctr97")
public class Controller97 {
   @Autowired
   private Controller97 controller0;
   @Autowired
   private Controller97 controller1;
   @Autowired
   private Controller97 controller2;
   @Autowired
   private Controller97 controller3;
   @Autowired
   private Controller97 controller4;
